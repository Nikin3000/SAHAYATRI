...
public class DrivAccActivity extends AppCompatActivity {
    ...
    private TextView Name,Address,Email,Phone,Taxi;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mDriverDatabase.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                Glide.with(DrivAccActivity.this)
                        .load(profileURL)
        ...
        mEdit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent startPageIntent = new Intent(DrivAccActivity.this , DriverSetProfileActivity.class);
